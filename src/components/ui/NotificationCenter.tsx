        ...
        <>
          ...
          >
            <div className="flex items-center justify-between px-4 py-2 border-b border-border-subtle shrink-0 bg-bg-base/50">
              <h3 id={titleId} className="font-medium text-text-primary">Notifications</h3>
              <button
                type="button"
            ...
            <div className="overflow-y-auto w-full flex-1 min-h-[200px]">
              {notifications.length === 0 ? (
                ...
                <div className="divide-y divide-border-subtle/50" role="list" aria-label="Notifications">
